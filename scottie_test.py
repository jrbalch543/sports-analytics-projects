...
for category_name in category_list:
    ...
    for game in category:
        if game.isdigit():
            score_list += [int(game)]
            running_mean = [mean(score_list)]
            means += running_mean
    game_scores[category_name] = score_list
    game_means[category_name] = means
   
def plot_game_scores():    
    for category_name in game_scores:
        plt.plot(game_scores[category_name])
